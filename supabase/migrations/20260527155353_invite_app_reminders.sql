...
revoke all on function app_private.accept_household_invite_record(uuid, text) from public;
revoke all on function app_private.accept_household_invite_record(uuid, text) from anon;
revoke all on function app_private.accept_household_invite_record(uuid, text) from authenticated;
...
as $$
begin
  return app_private.accept_household_invite_record(
    null::uuid,
    invite_token_hash
  );
end;
...
begin
  ...
  where lower(hi.email) = current_email
...
revoke all on function public.accept_household_invite_by_id(uuid) from public;
revoke all on function public.accept_household_invite_by_id(uuid) from anon;
grant execute on function public.accept_household_invite_by_id(uuid) to authenticated;

revoke all on function public.list_pending_household_invites() from public;
revoke all on function public.list_pending_household_invites() from anon;
grant execute on function public.list_pending_household_invites() to authenticated;
